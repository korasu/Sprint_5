...
class TestLK:
    def test_open_lk_page(self, driver_option, authorized):
        driver_option = authorized
    ...
    def test_switch_lk_to_construct_with_click_to_logo(self, driver_option, authorized):
        driver_option = authorized
    ...
    def test_switch_lk_to_construct_with_click_to_constructor_button(self, driver_option, authorized):
        driver_option = authorized
    ...
    def test_exit_from_lk(self, driver_option, authorized):
        driver_option = authorized
